...
var navStatus=[{'code':0, 'value':'停用'},{'code':1, 'value':'启用'},{'code':2, 'value':'默认显示'}];
var cssClassList=[{'code':'red_200_100', 'value':'红色200*100'},{'code':'red_100_100', 'value':'红色100*100'}
,{'code':'orange_200_100', 'value':'橙色200*100'},{'code':'orange_100_100', 'value':'橙色100*100'}
,{'code':'yellow_200_100', 'value':'黄色200*100'},{'code':'yellow_100_100', 'value':'黄色100*100'}
,{'code':'green_200_100', 'value':'绿色200*100'},{'code':'green_100_100', 'value':'绿色100*100'}
,{'code':'blue_200_100', 'value':'蓝色200*100'},{'code':'blue_100_100', 'value':'蓝色100*100'}
,{'code':'ndigo_200_100', 'value':'靛色200*100'},{'code':'ndigo_100_100', 'value':'靛色100*100'}
,{'code':'purple_200_100', 'value':'紫色200*100'},{'code':'purple_100_100', 'value':'紫色100*100'}];
// 扩展
...
$(function (){
	...
	$.getJSON(app.name+'/back/query/all/catalog', function(data) {
		if(data){
			catalogs=data;
		}
	});
